...
#define DECODE_DRM(REQUEST) if (request == REQUEST) {return #REQUEST;}
    ...
    else DECODE_DRM(DRM_IOCTL_I915_FLUSH) else DECODE_DRM(DRM_IOCTL_I915_FLIP) else DECODE_DRM(DRM_IOCTL_I915_BATCHBUFFER) else DECODE_DRM(DRM_IOCTL_I915_IRQ_EMIT) else DECODE_DRM(DRM_IOCTL_I915_IRQ_WAIT) else DECODE_DRM(DRM_IOCTL_I915_GETPARAM) else DECODE_DRM(DRM_IOCTL_I915_SETPARAM) else DECODE_DRM(DRM_IOCTL_I915_ALLOC) else DECODE_DRM(
        DRM_IOCTL_I915_FREE) else DECODE_DRM(DRM_IOCTL_I915_INIT_HEAP) else DECODE_DRM(DRM_IOCTL_I915_CMDBUFFER) else DECODE_DRM(DRM_IOCTL_I915_DESTROY_HEAP) else DECODE_DRM(DRM_IOCTL_I915_SET_VBLANK_PIPE) else DECODE_DRM(DRM_IOCTL_I915_GET_VBLANK_PIPE) else DECODE_DRM(DRM_IOCTL_I915_VBLANK_SWAP) else DECODE_DRM(DRM_IOCTL_I915_HWS_ADDR) else DECODE_DRM(DRM_IOCTL_I915_GEM_INIT) else DECODE_DRM(DRM_IOCTL_I915_GEM_EXECBUFFER) else DECODE_DRM(DRM_IOCTL_I915_GEM_EXECBUFFER2) else DECODE_DRM(DRM_IOCTL_I915_GEM_PIN) else DECODE_DRM(DRM_IOCTL_I915_GEM_UNPIN) else DECODE_DRM(DRM_IOCTL_I915_GEM_BUSY)
        // else DECODE_DRM(DRM_IOCTL_I915_GEM_SET_CACHEING)
        // else DECODE_DRM(DRM_IOCTL_I915_GEM_GET_CACHEING)
        else DECODE_DRM(DRM_IOCTL_I915_GEM_THROTTLE) else DECODE_DRM(DRM_IOCTL_I915_GEM_ENTERVT) else DECODE_DRM(DRM_IOCTL_I915_GEM_LEAVEVT) else DECODE_DRM(DRM_IOCTL_I915_GEM_CREATE) else DECODE_DRM(DRM_IOCTL_I915_GEM_PREAD) else DECODE_DRM(DRM_IOCTL_I915_GEM_PWRITE) else DECODE_DRM(DRM_IOCTL_I915_GEM_MMAP) else DECODE_DRM(DRM_IOCTL_I915_GEM_MMAP_GTT) else DECODE_DRM(DRM_IOCTL_I915_GEM_SET_DOMAIN) else DECODE_DRM(DRM_IOCTL_I915_GEM_SW_FINISH) else DECODE_DRM(DRM_IOCTL_I915_GEM_SET_TILING) else DECODE_DRM(DRM_IOCTL_I915_GEM_GET_TILING) else DECODE_DRM(DRM_IOCTL_I915_GEM_GET_APERTURE) else DECODE_DRM(DRM_IOCTL_I915_GET_PIPE_FROM_CRTC_ID) else DECODE_DRM(DRM_IOCTL_I915_GEM_MADVISE) else DECODE_DRM(DRM_IOCTL_I915_OVERLAY_PUT_IMAGE) else DECODE_DRM(DRM_IOCTL_I915_OVERLAY_ATTRS) else DECODE_DRM(DRM_IOCTL_I915_SET_SPRITE_COLORKEY) else DECODE_DRM(
            DRM_IOCTL_I915_GET_SPRITE_COLORKEY) else DECODE_DRM(DRM_IOCTL_I915_GEM_WAIT) else DECODE_DRM(DRM_IOCTL_I915_GEM_CONTEXT_CREATE) else DECODE_DRM(DRM_IOCTL_I915_GEM_CONTEXT_DESTROY) else DECODE_DRM(DRM_IOCTL_I915_REG_READ)
