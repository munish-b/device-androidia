...
// error code.
 ...
 public:
  ...
  //
  void SetWirelessCrtcParams(int32_t scaled_width, int32_t scaled_height,
                             int32_t refresh);
  ...
  uint32_t GetWirelessCrtcWidth() {
    return mWirelessCrtcWidth;
  }
  uint32_t GetWirelessCrtcHeight() {
    return mWirelessCrtcHeight;
  }
  uint32_t GetWirelessCrtcRefresh() {
  ...
  void ConfigureImageDump(android::sp<Hwcval::Selector> selector,
  ...
  void SetDrmFunctions(FPdrm_intel_bo_map fpdrm_intel_bo_map,
                       FPdrm_intel_bo_unmap fpdrm_intel_bo_unmap);
...
// Access to DRM function pointers
inline void HwcTestState::SetDrmFunctions(
    FPdrm_intel_bo_map fpdrm_intel_bo_map,
    FPdrm_intel_bo_unmap fpdrm_intel_bo_unmap) {
