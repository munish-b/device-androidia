...
#define HWCVAL_MODE_FLAG_PREFERRED HWCS_MODE_FLAG_PREFERRED
  ...
  void SetUserModeFinish(android::status_t st, uint32_t width, uint32_t height,
...
inline void HwcTestCrtc::SetVideoLayerIndex(int layerIndex,
