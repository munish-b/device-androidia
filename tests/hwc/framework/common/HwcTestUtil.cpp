...
#define PRINT_FMT(FMT) \
  ...
  else PRINT_FMT(HAL_PIXEL_FORMAT_BGRA_8888) else PRINT_FMT(HAL_PIXEL_FORMAT_RGBX_8888) else PRINT_FMT(HAL_PIXEL_FORMAT_RGB_565) else PRINT_FMT(HAL_PIXEL_FORMAT_RGBA_4444_INTEL) else PRINT_FMT(
      HAL_PIXEL_FORMAT_NV12_Y_TILED_INTEL) else PRINT_FMT(HAL_PIXEL_FORMAT_NV12_X_TILED_INTEL) else PRINT_FMT(HAL_PIXEL_FORMAT_NV12_LINEAR_INTEL) else PRINT_FMT(HAL_PIXEL_FORMAT_NV12_LINEAR_PACKED_INTEL) else PRINT_FMT(HAL_PIXEL_FORMAT_NV12_LINEAR_CAMERA_INTEL)

      else PRINT_FMT(HAL_PIXEL_FORMAT_YUV420PackedSemiPlanar_INTEL) else PRINT_FMT(
          HAL_PIXEL_FORMAT_YUV420PackedSemiPlanar_Tiled_INTEL)

      else PRINT_FMT(HAL_PIXEL_FORMAT_YCbCr_422_I) else PRINT_FMT(HAL_PIXEL_FORMAT_YCbCr_420_H_INTEL) else PRINT_FMT(HAL_PIXEL_FORMAT_YCbCr_411_INTEL) else PRINT_FMT(
          HAL_PIXEL_FORMAT_YCbCr_422_V_INTEL) else PRINT_FMT(HAL_PIXEL_FORMAT_YCbCr_422_H_INTEL) else PRINT_FMT(HAL_PIXEL_FORMAT_YCbCr_444_INTEL) else {
    return "UNKNOWN";
  }
#undef PRINT_FMT
}
