...
Hwcval::BlendingType Hwc2BlendingTypeToHwcval(uint32_t blendingType);
uint32_t HwcvalBlendingTypeToHwc2(Hwcval::BlendingType blendingType);
...
class Hwc2Layer : public ValLayer {
 public:
  Hwc2Layer(const hwcval_layer_t *sfLayer, android::sp<DrmShimBuffer> &buf);
};
