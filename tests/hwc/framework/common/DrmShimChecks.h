...
class EXPORT_API DrmShimChecks : public HwcTestKernel {
 protected:
  ...
  android::DefaultKeyedVector<uint32_t, android::sp<DrmShimBuffer> >
      mBuffersByFbId;
 ...
 public:
  ...
  EXPORT_API int CheckSetDisplayEnter(drm_mode_set_display* drmDisp,
                                      DrmShimCrtc*& crtc);

  EXPORT_API void CheckSetDisplayExit(drm_mode_set_display* drmDisp,
                                      DrmShimCrtc* crtc, int ret);

  EXPORT_API bool ConvertToSetDisplay(
  ...
  EXPORT_API void CheckIoctlI915SetPlaneZOrder(
  ...
  EXPORT_API void CheckIoctlI915DispScreenControl(
 ...
 protected:
  ...
  android::sp<DrmShimBuffer> UpdateBufferPlane(uint32_t fbId, DrmShimCrtc* crtc,
                                               DrmShimPlane* plane);
