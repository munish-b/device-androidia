...
HwcTestCompValThread::HwcTestCompValThread()
    : mValSeq(0), mFenceForClosure(0), mConsecutiveAbortedCompareCount(0) {
...
bool HwcTestCompValThread::Compose(android::sp<DrmShimBuffer> buf,
  ...
  for (uint32_t i = 0; i < numSources; ++i) {
    ...
    HwcvalLayerToHwc1("HwcTestCompValThread::Compose: input", i, valSources[i],
