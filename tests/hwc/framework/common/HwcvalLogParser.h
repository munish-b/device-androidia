...
class LogParser : public Hwcval::LogChecker {
 private:
  ...
  bool ParseSetOptimizationModeExit(pid_t pid, int64_t timestamp,
                                    const char* str);
  bool ParseWidiSetSingleDisplayEntry(pid_t pid, int64_t timestamp,
                                      const char* str);
  bool ParseWidiSetSingleDisplayExit(pid_t pid, int64_t timestamp,
                                     const char* str);
