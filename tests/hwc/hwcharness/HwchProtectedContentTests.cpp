...
int Hwch::ProtectedVideoTest::RunScenario() {
  ...
  SetExpectedMode(
      HwcTestConfig::eDontCare);  // cloning not done for protected content
...
Hwch::ProtectedVideoHotPlugTest::ProtectedVideoHotPlugTest(
    Hwch::Interface& interface)
    : Hwch::Test(interface) {
}

int Hwch::ProtectedVideoHotPlugTest::RunScenario() {
  // This test usually fails this check, so until it's been debugged we will set
  // it to a warning.
...
Hwch::ProtectedVideoScreenDisableTest::ProtectedVideoScreenDisableTest(
    Hwch::Interface& interface)
    : Hwch::Test(interface) {
}
...
Hwch::InvalidProtectedVideoTest::InvalidProtectedVideoTest(
    Hwch::Interface& interface)
    : Hwch::Test(interface) {
}
...
int Hwch::InvalidProtectedVideoTest::RunScenario() {
  ...
  Hwch::ProtectedVideoLayer layer1(Hwch::Layer::eEncrypted |
  ...
  frame.Remove(layer1);
  Hwch::ProtectedVideoLayer layer2(Hwch::Layer::eEncrypted |
...
Hwch::ComplexProtectedVideoTest::ComplexProtectedVideoTest(
    Hwch::Interface& interface)
    : Hwch::Test(interface) {
}
