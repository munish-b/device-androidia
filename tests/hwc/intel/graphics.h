 ...
 *
 * Range 0x100 - 0x1FF is reserved for pixel formats specific to the HAL
 *implementation
 *
...
enum {
  ...
  /**
   * Three planes, 8 bit Y plane followed by 8 bit 2x1 subsampled U and V
   *planes.
  ...
  /**
   * Three planes, 8 bit Y plane followed by U, V plane with 1/4 width and full
   *height.
  ...
  /**
   * Three planes, 8 bit Y plane followed by U, V plane with 1/2 width and 1/2
   *height.
   * The U and V planes have the same stride as the Y plane.
  ...
  /**
   * Three planes, 8 bit Y plane followed by U, V plane with full width and 1/2
   *height.
   * Horizontal stride is aligned to 128.
   * Vertical stride is aligned to 64.
   *       ________________________ .....
  ...
  /**
   * Three planes, 8 bit Y plane followed by U, V plane with full width and full
   *height.
   * Horizontal stride is aligned to 128.
   * Vertical stride is aligned to 64.
   *       ________________________ .....
