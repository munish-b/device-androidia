...
*
* File Name:            valhwc_gallery_test.cpp
*
* Description:          Create surfaces used by Android when viewing the gallery
*                       main screen.
*
...
int HwcTestTest::Run(void)
{
    SurfaceSender::SurfaceSenderProperties
        sSSP1(SurfaceSender::epsGallerySurface);
    CreateSurface(sSSP1);

    SurfaceSender::SurfaceSenderProperties
        sSSP2(SurfaceSender::epsGalleryUI);
    CreateSurface(sSSP2);
