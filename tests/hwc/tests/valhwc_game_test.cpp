...
*
* File Name:            valhwc_game_test.cpp
*
* Description:          Create surfaces used by Android with a full screen game.
*
...
int HwcTestTest::Run(void)
{
    SurfaceSender::SurfaceSenderProperties
        sSSP1(SurfaceSender::epsGameSurfaceFullScreen);
    CreateSurface(sSSP1);

    SurfaceSender::SurfaceSenderProperties
        sSSP2(SurfaceSender::epsNavigationBar);
    CreateSurface(sSSP2);

    SurfaceSender::SurfaceSenderProperties
        sSSP3(SurfaceSender::epsAdvertPane);
    CreateSurface(sSSP3);
