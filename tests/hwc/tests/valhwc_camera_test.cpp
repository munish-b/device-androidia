...
*
* File Name:            valhwc_camera_test.cpp
*
* Description:          Create surfaces used by Android when viewing a
*                       photograph capture in the camera application.
*
...
int HwcTestTest::Run(void)
{
    ...
    SurfaceSender::SurfaceSenderProperties
        sSSP1(SurfaceSender::epsCameraSurface);
    CreateSurface(sSSP1);

    SurfaceSender::SurfaceSenderProperties
        sSSP2(SurfaceSender::epsCameraUI);
    CreateSurface(sSSP2);
