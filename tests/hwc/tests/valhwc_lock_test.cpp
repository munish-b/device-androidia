...
*
* File Name:            valhwc_lock_test.cpp
*
* Description:          Create surfaces used by Android when on the lock screen.
*
...
int HwcTestTest::Run(void)
{
    ...
    SurfaceSender::SurfaceSenderProperties
        sSSP3(SurfaceSender::epsStatusBar);
    CreateSurface(sSSP3);

    SurfaceSender::SurfaceSenderProperties
        sSSP4(SurfaceSender::epsKeyGuard);
    CreateSurface(sSSP4);
